---
name: bse-batch-review
description: "BMAD Story Engine - Batch Review Orchestrator. Deep code review and hardening workflow."
mode: primary
...
permission:
  task:
    "bse-deep-reviewer": allow
    "bse-issue-fixer": allow
    "bse-arbiter": allow
    "bse-inspector": allow
---
